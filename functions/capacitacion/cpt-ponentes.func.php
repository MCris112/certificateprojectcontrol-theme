...
function cpc_capacitacion_product_ponentes_register_meta_box()
{
    ...
    add_meta_box('cpc_capacitacion_product_ponentes_meta_box_info', 'Ponentes', 'cpc_capacitacion_product_ponentes_meta_box_callback', 'post', 'normal', 'low');
}
...
<?php
        ...
        echo "No se han encontrado ponentes";
    }
    wp_reset_postdata();
    /*
...
{
    if (!isset($_POST['cpc_capacitacion_meta_box_nonce_ponentes'])) {
        return;
    }
