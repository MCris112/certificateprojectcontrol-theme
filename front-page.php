    ...
    <div class="swiper-wrapper" id="swiper-wrapper-7c7323f1067206ecc" aria-live="polite" style="transition-duration: 0ms;">
            ...
            <div class="cpc_slider_item cpc_hero">
                ...
                <div class="text">
                    <div class="container content">
                        <h1 class="cpc_title">PROPONEMOS SOLUCIONES GENERANDO VALOR</h1>
                        <span class="cpc_subtitle">¿Listos para comenzar?</span>

                        <a href="<?php echo get_permalink(wc_get_page_id('shop')); ?>" class="cpc_btn icon_side side_down">
                            <div class="icon">
        ...
        <div class="swiper-slide swiper-slide-visible swiper-slide-active" style="width: 1920px; opacity: 1; transform: translate3d(-1920px, 0px, 0px); transition-duration: 0ms;" role="group" aria-label="2 / 4">
            <div class="cpc_slider_item cpc_hero">
                ...
                <div class="text">
                    <div class="container content">
                        <h1 class="cpc_title">Nuestros Proximos Inicios</h1>
                        <span class="cpc_subtitle">¿Listos para comenzar?</span>

                        <a href="" class="cpc_btn icon_side">
                            <div class="icon">
