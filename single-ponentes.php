...
<section class="cpc_ponentes_section">
    <div class="container">
        <div class="row cpc_ponentes_container">
            ...
            <div class="col">
                ...
                <p class="certificados"><svg xmlns="http://www.w3.org/2000/svg" width="38" height="42" fill="none" viewBox="0 0 38 42">
                        <g clip-path="url(#a)">
                ...
                <p class="subtitle_txt"><?php echo cpc_get_meta_field('_cpc_ponentes_meta_box_subtitle_key'); ?></p>
                <p class="desc"><?php echo htmlspecialchars_decode(cpc_get_meta_field('_cpc_ponentes_meta_box_desc_key')); ?></p>
            </div>
        </div>
